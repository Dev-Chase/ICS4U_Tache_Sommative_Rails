...
class StudentCoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_course" do
    assert_difference("StudentCourse.count") do
      post student_courses_url, params: { student_course: { average_grade: @student_course.average_grade, course_id: @student_course.course_id, credit_obtained: @student_course.credit_obtained, student_id: @student_course.student_id } }
    end
  ...
  test "should update student_course" do
    patch student_course_url(@student_course), params: { student_course: { average_grade: @student_course.average_grade, course_id: @student_course.course_id, credit_obtained: @student_course.credit_obtained, student_id: @student_course.student_id } }
