...
class CourseSessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_session" do
    assert_difference("CourseSession.count") do
      post course_sessions_url, params: { course_session: { course_id: @course_session.course_id, day_of_week: @course_session.day_of_week, duration: @course_session.duration, room_id: @course_session.room_id, start_time: @course_session.start_time } }
    end
  ...
  test "should update course_session" do
    patch course_session_url(@course_session), params: { course_session: { course_id: @course_session.course_id, day_of_week: @course_session.day_of_week, duration: @course_session.duration, room_id: @course_session.room_id, start_time: @course_session.start_time } }
