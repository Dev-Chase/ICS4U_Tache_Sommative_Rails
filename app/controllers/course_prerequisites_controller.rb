class CoursePrerequisitesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to course_prerequisites_path, status: :see_other, notice: "Course prerequisite was successfully destroyed." }
  ...
  private
    ...
    def course_prerequisite_params
      params.require(:course_prerequisite).permit(:course_id, :prerequisite_course_id)
    end
end
